...
public class MinInitializer implements ApplicationListener<ApplicationReadyEvent> {
        ...
        public void onApplicationEvent(ApplicationReadyEvent event) {
                ...
                creationHelperTool.detailProductAndSave(mouse, categoryMap.get("Gaming"),
                ...
                creationHelperTool.detailProductAndSave(headsetOffice, categoryMap.get("Gaming"),
                                categoryMap.get("Office"),
                ...
                creationHelperTool.detailProductAndSave(wiredHeadset, categoryMap.get("Gaming"),
                                categoryMap.get("Headset"));
                ...
                creationHelperTool.detailProductAndSave(gamingHeadset, categoryMap.get("Gaming"),
                                categoryMap.get("Headset"));
